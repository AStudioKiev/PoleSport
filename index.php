        ...
        <div class="container-md flex-btw">
            ...
            <div class="course-text">
                ...
                <ul class="lessons-list">
                    <li class="popup-left">Анатомия и Физиология</li>
                    <li class="popup-left">Методика преподавания спорта на пилоне, страховка и безопасность</li>
                    <li class="popup-left">Правильный комплекс упражнений для подготовки тела с пилоном, а также расслабление после физических нагрузок (стретчинг)</li>
                    <li class="popup-left">Биомеханика и восстановление организма</li>
                    <li class="popup-left">Хореография</li>
                    <li class="popup-left">Детский pole sport</li>
                    <li class="popup-left">Подготовка спортсменов к соревнованиям</li>
                </ul>
            </div>
        </div>
